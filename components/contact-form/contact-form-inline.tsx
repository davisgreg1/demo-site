...
export function ContactFormInline({ values, errors, onChange, onSubmit }: ContactFormInlineProps) {
  return (
    <form className="grid gap-6 lg:grid-cols-[1fr_1fr]" onSubmit={(event) => { event.preventDefault(); onSubmit(); }}>
