  ...
  return (
    <section className="bg-primary text-primary-foreground">
      <div className="mx-auto flex max-w-7xl flex-col gap-6 px-6 py-16 text-center lg:px-8">
        ...
        <a href={content.cta.href} className="mx-auto inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-foreground transition hover:bg-slate-100">
          {content.cta.label}
        </a>
      </div>
    </section>
